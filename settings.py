...
DEFAULTS = {
    ...
    "descriptions": ["Google DNS", "Cloudflare DNS", "Google"],
    "interval_s": 0.5,
    "timeout_ms": 500,
    "count": 120,
}
...
class Settings:
    ...
    def __init__(
        ...
        self.host_descriptions = host_descriptions if host_descriptions is not None else {DEFAULTS["hosts"][i]: DEFAULTS["descriptions"][i] for i in range(len(DEFAULTS["hosts"]))}
